...
import (
	...
	"github.com/do-something-for-fun/ydict/lib"
...
func main() {
	...
	rootCmd.PersistentFlags().BoolVarP(&withCache, "cache", "c", true, "Query with local cache, and save the query word(s) into the cache.")
